...
if ($arParams["SEF_MODE"] == "Y") {
    $resUrl = $arParams["SEF_FOLDER"].str_replace("#PARAM1#", $param1, $arParams["SEF_URL_TEMPLATES"]["exampage"]) . "?PARAM2=$param2";
} else{
    $resUrl = $APPLICATION->GetCurPage() . "?PARAM1=$param1&PARAM2=$param2";
}

?>
<?= GetMessage("EXAM_TEXT_LINK_CP_PHOTO") ?> <a href="<?= $resUrl ?>"><?= $resUrl ?></a>
